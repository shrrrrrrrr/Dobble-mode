...
export const themePacks: ThemePack[] = [
  { id: 'mint', name: '默认主题', shortName: '默认', description: '浅蓝像素桌面与动态骑行背景。', available: true, backgroundVideo: '/assets/pixel-original-clean.mp4', poster: '/assets/pixel-original-poster.jpg' },
